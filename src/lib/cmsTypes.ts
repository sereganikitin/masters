...
export const ABOUT_CONSTRUCTION_DEFAULTS: AboutConstructionContent = {
  ...
  period: "Июнь 2026",
  intro:
    "На строительной площадке премиального дома подходят к концу работы по ограждению будущего котлована по технологии «стена в грунте» с форшахтой.",
  bullets: [
    "Возведение «стены в грунте» — бетонного ограждения котлована, выполняющего защитную функцию.",
    "Выполнено 334 погонных метра — 75% от общего объёма.",
    "Завершение основного объёма этапа запланировано на первую декаду июля 2026 года.",
  ],
  photo: "/images/construction/2026-06-1.jpg",
