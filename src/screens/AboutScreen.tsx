...
import { IconClose, IconArrowRight, IconMap, IconCube, IconPhone } from "@/components/Icon";
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-base-0">
      ...
      <Pressable
        ...
        className="absolute right-9 top-9 z-50 grid h-14 w-14 place-items-center rounded-full bg-base-0/90 text-base-800 shadow-card backdrop-blur-md"
        aria-label="Закрыть"
      >
        <IconClose size={22} />
      </Pressable>
      ...
      <div className="relative z-10 flex h-full flex-col justify-between p-16">
        <Reveal mode="up" delay={50}>
          <div className="flex items-center gap-4">
            <div className="grid h-12 w-12 place-items-center rounded-sm bg-base-0 text-base-800">
        ...
        <div className="max-w-[1240px]">
          ...
          <Reveal mode="up" delay={250}>
            <h1 className="mt-6 font-display text-[120px] font-semibold leading-[0.95] tracking-[-0.02em]">
              Премиальный
              <br />
              дом МАСТЕРС
            </h1>
          ...
          <Reveal mode="up" delay={400}>
            <p className="mt-8 max-w-[840px] font-sans text-h4 text-base-0/85">
              Ансамбль разновысотных секций от 8 до 25 этажей у метро Аэропорт. Приватный двор и
              линейный парк с амфитеатром. Клубная гостиная с камином и коворкинг только для
              резидентов.
            </p>
          </Reveal>
        </div>
    ...
    <section className="bg-base-0 py-32">
      <div className="mx-auto max-w-[1640px] px-16">
        ...
        <Reveal mode="up" delay={120}>
          <h2 className="mt-6 max-w-[1200px] font-display text-[72px] font-semibold leading-[1.05] tracking-tight text-base-800">
        ...
        <div className="mt-16 grid grid-cols-4 gap-10 border-t border-base-200 pt-12">
          {stats.map((s, i) => (
            <Reveal key={s.unit} mode="up" delay={i * 100}>
              <div>
                <div className="font-display text-[64px] font-semibold leading-none tracking-tight text-base-800">
                  {s.value}
                </div>
  ...
  return (
    <section className="bg-base-100 py-32">
      <div className="mx-auto max-w-[1640px] px-16">
        ...
        <Reveal mode="up" delay={120}>
          <h2 className="mt-6 max-w-[1200px] font-display text-[64px] font-semibold leading-tight tracking-tight text-base-800">
        ...
        <div className="mt-16 grid grid-cols-3 gap-5">
          {items.map((it, i) => (
            <Reveal key={it.title} mode="up" delay={(i % 3) * 100}>
              <div className="h-[340px] bg-base-0 p-10 transition-colors hover:bg-night-500 hover:text-base-0">
                ...
                <div className="mt-auto">
                  ...
                  <p className="mt-3 font-sans text-body text-base-600 group-hover:text-base-0/80">
                    {it.note}
                  </p>
                </div>
              </div>
...
function Engineering() {
  ...
  return (
    <section className="relative h-[700px] w-full overflow-hidden bg-night-500 text-base-0">
      <div ref={bgRef} className="absolute inset-0 -top-[5%] h-[110%]">
        <img src="/images/hero-about.png" alt="" className="h-full w-full object-cover opacity-50" />
      </div>
      ...
      <div className="relative z-10 grid h-full grid-cols-2 px-16">
        <div className="flex flex-col justify-center">
          ...
          <Reveal mode="up" delay={120}>
            <h2 className="mt-6 font-display text-[64px] font-semibold leading-tight tracking-tight">
              Незаметный комфорт
            </h2>
          </Reveal>
          <Reveal mode="up" delay={220}>
            <p className="mt-8 max-w-[640px] font-sans text-h5 text-base-0/85">
              Приточно-вытяжная вентиляция с подогревом, индивидуальные тепловые узлы, бесперебойное
              водоснабжение с трёхступенчатой очисткой, резервное электропитание и Wi-Fi покрытие во
              всех общественных зонах.
            </p>
          </Reveal>
      ...
      <div className="mx-auto max-w-[1640px] px-16">
        <div className="grid grid-cols-[1fr_auto] items-end">
          <div>
            ...
            <Reveal mode="up" delay={120}>
              <h2 className="mt-6 max-w-[1100px] font-display text-[64px] font-semibold leading-tight tracking-tight text-base-800">
    ...
    <section className="relative h-[640px] w-full overflow-hidden bg-base-100">
      ...
      <div className="relative z-10 grid h-full max-w-[1640px] grid-cols-2 px-16">
        <div className="flex flex-col justify-center">
          ...
          <Reveal mode="up" delay={120}>
            <h2 className="mt-6 font-display text-[56px] font-semibold leading-tight tracking-tight text-base-800">
      ...
      <div className="mx-auto max-w-[1640px] px-16">
        <div className="grid grid-cols-[1fr_auto] items-end gap-10">
          <div>
            ...
            <Reveal mode="up" delay={120}>
              <h2 className="mt-6 max-w-[1100px] font-display text-[56px] font-semibold leading-tight tracking-tight">
                Вся проектная документация на портале ДОМ.РФ
              </h2>
            </Reveal>
            <Reveal mode="up" delay={220}>
              <p className="mt-8 max-w-[860px] font-sans text-h5 text-base-0/70">
                Актуальные планы, разрешения, проектные декларации и другие официальные материалы
